...
# Rentals
    ...
    path('exchange_rate/<str:to_currency>/<str:from_currency>/<int:amount>/', views.exchange_rate),
    ...
    path('rentals/booking-rules/<int:id>', views.rental_booking_rules),
    path('rentals/booking-rules-update/<int:id>', views.rental_booking_rules_update),
...
# Channels  
    ...
    path('channels/<int:id>', views.channel_edit),  
...
# Reports
    ...
    # path('account-setting-update/<int:id>',views.account_setting_update),
