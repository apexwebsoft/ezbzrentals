...
def auth_view(request):
    ...
    if username == 'demon':
        ...
        if user is not None:
                ...
                pass
    context = {}
    return render(request,'super/authentication/login.html',context)  
...
def user_profile(request):
    ...
    return render(request, "super/users/user-profile.html", {'users': users})
...
def channel_insert(request):
    if request.method == "POST": 
        ...
        employee.request_booking=request.POST.get('request_booking')
