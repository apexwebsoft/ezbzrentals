...
class UserProfile(models.Model): 
    ...
    language_spoken=models.CharField(max_length=1000)
...
class Channel(models.Model):  
    ...
    request_booking = status = models.BooleanField(default=False)
...
class ChannelManagement(models.Model):
    channels=models.CharField(max_length=1000)
    request_booking=models.CharField(max_length=500,null=True)
    user_id = models.IntegerField()
...
class RentalBookingRules(models.Model):
    ...
    def __str__(self):
        return self.prefered_policy    
    

class AccountSetting(models.Model):
    account_type=models.CharField(max_length=1000)
    account_email_address=models.CharField(max_length=1000)
    prefered_currency=models.CharField(max_length=1000,null=True, blank=True)
    selected_plan=models.CharField(max_length=1000,null=True, blank=True)
    user_id = models.IntegerField()
    status = models.BooleanField(default=True)
